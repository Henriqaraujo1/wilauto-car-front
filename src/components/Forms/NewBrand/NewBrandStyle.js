...
export const DivNewBrand = styled.div`
  width: 50%;
...
export const TitleNewBrand = styled.h1`
  font-size: 20px;
  display: flex;
...
export const FormBrand = styled.form`
  ...
  justify-content: center;
`;
export const DivOrgBrand = styled.div`
  width: 100%;
  height: 36px;
  margin: 10px auto;
...
export const BtnRemoveBrand = styled.button`
  width: 40%;
  height: 47px;
...
`;
export const SubmitBrand = styled.button`
  width: 40%;
  height: 47px;
  color: ${Colors.Text.Black};
