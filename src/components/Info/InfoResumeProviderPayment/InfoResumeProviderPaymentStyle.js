...
export const DivOrgResumeProviderPayment = styled.div`
  width: 100%;
  /* height: 150px; */
...
export const DivInfoResumeProviderPayment = styled.div`
  width: 90%;
  padding: 10px;
  display: flex;
  flex-direction: row;
...
export const InfoResumeProviderPaymentResult = styled.p`
  font-size: 0.9em;
`;
