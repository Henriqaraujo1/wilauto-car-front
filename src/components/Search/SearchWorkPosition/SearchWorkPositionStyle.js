...
export const DivSearchPosition = styled.div`
  width: 50%;
  height: 500px;
...
export const TitleSearchPosition = styled.h1`
  font-size: 20px;
  display: flex;
...
export const DivIdPosition = styled.div`
  width: 10%;
  margin-right: 10px;
  display: flex;
  justify-content: center;
  ...
  border-radius: 100%;
`;
export const DivPositionInfo = styled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
`;
